...
Le attività di codifica hanno come scopo l'implementazione concreta del \textit{software} in base alla specifica fornita dalle attività di progettazione. \\
...
\begin{lstlisting}[language=JavaScript, caption={Visualizzazione e valorizzazione degli attributi - TypeScript}]
...
\subsection*{Modifica dei dati di qualità}
\begin{lstlisting}[language=JavaScript, caption={Modifica dei dati di qualità - TypeScript}]
    /**
