...
\begin{figure}[H]
  ...
  \caption[Diagramma degli strumenti di documentazione]{Diagramma che rappresenta la relazione tra la documentazione (gestita tramite \textit{GitHub}) e gli strumenti adottati per scriverla / per generare i diagrammi}
\end{figure}
