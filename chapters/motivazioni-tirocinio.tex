...
Ho rispettato la pianificazione delle attività, redatta anticipatamente rispetto all'inizio del progetto e disponibile di seguito, per la maggior parte del tempo di tirocinio: solamente l'interfacciamento coi servizi
...
La scelta del progetto di tirocinio curricolare offerto da \textit{\textbf{Trizeta}}:
\begin{itemize}
