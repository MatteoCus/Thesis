...
Come già indicato nella sezione precedente, \textit{\textbf{Trizeta}} intrattiene relazioni commerciali esclusivamente di tipo \textit{B2B}\footnote{\gls{b2b}}: questa visione si riflette inevitabilmente sui prodotti offerti
e sull'insieme dei requisiti utente soddisfatti dai prodotti di seguito elencati.

%ADeWMS

\begin{itemize}
    \item \textit{ADeWMS}: è un \textit{WMS} (gestionale relativo al contenuto e alle attività di magazzino)
    \item \textit{P4NDOR4}
    \item \textit{ADeMES}
\end{itemize}
