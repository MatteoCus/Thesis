...
% In questa sezione descriverò brevemente i prodotti ed i servizi offerti dall'azienda che ho potuto vedere (mi focalizzerò su un prodotto in particolare, dato che il \textit{software} che ho prodotto nel corso del tirocinio andrà ad essere integrato con esso).
...
\begin{itemize}
    ...
    \item \textit{P4NDOR4}: è un \textit{DAM}\footnote{\gls{damg}} (gestionale per \glslink{digital-asset}{\textit{digital assets}}, risorse digitali, aziendali) con possibilità di richiedere delle risorse direttamente a \textit{\textbf{Trizeta}};
    \begin{figure}[H]
        \centering
