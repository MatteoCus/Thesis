...
\begin{itemize}
    ...
    \item \textbf{Sviluppo}: le attività qui descritte sono svolte ciclicamente in periodi di tempo più o meno ampi, la cui ampiezza deriva dagli obiettivi prefissati per il singolo periodo.
        ...
        \begin{figure}[H]
            ...
            \caption[Caption for LOF]{Attività di un periodo \hyperref[app:agile]{agile} \footnotemark}
        \end{figure}
        {\footnotetext{Fonte: \href{https://mlsdev.com/blog/agile-sdlc}{https://mlsdev.com}}}
    \item \textbf{Manutenzione}: per quanto riguarda la manutenzione dei prodotti, l'azienda ospitante si avvale di un sistema di \textit{ticketing} per la gestione delle segnalazioni (disservizi o anomalie) e comunicazione
