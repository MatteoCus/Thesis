...
\begin{document}
    ...
    \mainmatter
    \input{chapters/contesto-svolgimento}
    \input{chapters/motivazioni-tirocinio}
    \input{chapters/elementi-progetto}
    \input{chapters/resoconto}

    % \appendix
    % \input{appendix/appendice-a.tex}
